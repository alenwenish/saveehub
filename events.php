...
<body>
    ...
    <div class="text-center">
        <h4 class="ps-3">
            ...
            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
            <span>
                <i class="fa-solid fa-ellipsis-vertical btn" data-bs-toggle="modal"
                    data-bs-target="#I<?php echo  $row['id']; ?>">
                </i>
            </span>

            <div class="modal fade " id="I<?php echo  $row['id']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel"
                aria-hidden="true">
                <div class="modal-dialog ">
                    <div class="modal-content ">
                        <div class="modal-body d-flex justify-content-between bg-secondary">
                            ...
                            <form method="POST">
                                <button class="btn text-start text-light" type="submit" value=<?php echo  $row['id']; ?>
                                    name="savepost">
        ...
        <h4 class="p-1">
            ...
            <a href="comments.php?id=<?php echo $row['id'] ?>&owner=<?php echo $row['username']; ?>&comment_status=1"
