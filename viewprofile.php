...
<body id="view_profile">
  ...
  <div class="container  p-1" id="post">
    ...
    ?>
        ...
        <img src="./uploads/<?php echo $data['post']; ?>" width="30%" height="10%" alt="" class="images btn d-inline" data-bs-toggle="modal" data-bs-target="#<?php echo $data['username']; ?><?php echo $data['id']; ?>" >
