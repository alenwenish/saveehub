...
<body id="signup_body">
    ...
    <div class="container  position-relative">
        ...
        <div class="tilt-in-fwd-tr card mb-3  mx-auto p-3 " id="sign_up_card">
            ...
            <form action="" method="POST" class="m-2">
                ...
                <div class="mb-3 ">
                    <label for="number" class="form-label text-white"> <i class="fa-solid fa-phone"></i> Phone
                        Number:</label>
        ...
        <div class="tilt-in-fwd-tl card mb-3  mx-auto p-3 " id="sign_up_club_card">
            ...
            <form action="" method="POST" class="m-2">
                ...
                <div class="mb-3">
                    ...
                    <input type="email" class="form-control shadow" id="club_email" name="club_email"
                        placeholder="example@gmail.com" required>
                </div>

                <div class="mb-3 ">
                    <label for="coord" class="form-label "> <i class="fa-solid fa-user-pen"></i> Student
                        Coordinator:</label>
                    <input type="text" class="form-control shadow" id="club_sc" name="club_sc" required>
                </div>

                <div class="mb-3 ">
                    <label for="coord" class="form-label text-white"> <i class="fa-solid fa-user-pen"></i> Faculty
                        Coordinator:</label>
